...
const POSTS = {
  ...
  'how-to-use-jasper': {
    title: 'How to Write Blog Posts with Jasper AI — Complete Tutorial',
    desc: 'Step-by-step guide to using Jasper for long-form content. Templates, brand voice, and SEO mode.',
    date: 'May 2026',
    content: [
      { type:'p', text:'Jasper is the best AI writing tool for long-form content. Here is exactly how to use it to write blog posts in half the time.' },
      { type:'h2', text:'Step 1: Choose a Template' },
      { type:'p', text:'Jasper offers 50+ templates. For blog posts, start with "Blog Post Intro Paragraph" or "Long-Form Assistant." The One-Shot Blog Post template generates a full draft from a topic and tone.' },
      { type:'h2', text:'Step 2: Set Up Brand Voice' },
      { type:'p', text:'Upload existing content and Jasper learns your writing style. This is what separates Jasper from cheaper alternatives — the AI actually sounds like you after training. Spend 10 minutes setting this up before writing.' },
      { type:'h2', text:'Step 3: Use SEO Mode' },
      { type:'p', text:'Toggle SEO mode and paste your target keyword. Jasper integrates with Surfer SEO to suggest keywords, headings, and word count targets. The content score updates as you write.' },
      { type:'h2', text:'Step 4: Edit and Polish' },
      { type:'p', text:'AI writes the draft — you add personal experience, data, and unique insights. Never publish raw AI output. Fact-check everything. Add screenshots and real examples for credibility.' },
    ],
  },
  'midjourney-prompt-guide': {
    title: 'Midjourney Prompt Guide: Create Better AI Images',
    desc: 'Master Midjourney prompts. Parameters, style keywords, aspect ratios, and advanced techniques.',
    date: 'May 2026',
    content: [
      { type:'p', text:'Midjourney generates stunning images — but only if you write good prompts. Here is how to go from beginner to pro.' },
      { type:'h2', text:'The Basic Prompt Formula' },
      { type:'p', text:'Subject + Style + Lighting + Composition + Parameters. Example: "A cyberpunk city at night, neon lights reflecting on wet streets, cinematic lighting, ultra detailed, --ar 16:9 --v 6"' },
      { type:'h2', text:'Key Parameters' },
      { type:'p', text:'--ar 16:9 sets aspect ratio. --v 6 uses the latest model. --stylize 0-1000 controls artistic freedom. --chaos 0-100 adds variation across generations. --no negative prompts remove unwanted elements.' },
      { type:'h2', text:'Style Keywords That Work' },
      { type:'p', text:'"Photorealistic, 8K, cinematic lighting, bokeh, macro photography" for photos. "Oil painting, watercolor, impressionist, artstation" for paintings. "3D render, octane, unreal engine, isometric" for 3D.' },
    ],
  },
  'how-to-code-with-cursor': {
    title: 'How to Code Faster with Cursor AI — Complete Guide',
    desc: 'Master Cursor tab completion, inline chat (Cmd+K), and Composer for multi-file edits.',
    date: 'May 2026',
    content: [
      { type:'p', text:'Cursor is the most powerful AI coding tool available. Here is how to use it effectively for real development work.' },
      { type:'h2', text:'Tab Completion: Your Copilot on Steroids' },
      { type:'p', text:'Cursor predicts your next edit — not just the next line. It understands your entire codebase context. Type naturally and accept suggestions with Tab. The more you code in a project, the better it gets.' },
      { type:'h2', text:'Cmd+K: Edit Without Leaving Your Flow' },
      { type:'p', text:'Select any code and press Cmd+K. Describe the change you want in plain English. Cursor rewrites only the selected code. Perfect for refactoring, adding error handling, or converting syntax.' },
      { type:'h2', text:'Composer: Multi-File AI Agent' },
      { type:'p', text:'Composer (Cmd+I) can modify multiple files in one prompt. "Add a logout button to every page and create a logout API endpoint." It touches the components and creates the API file simultaneously.' },
    ],
  },
  'leonardo-ai-tutorial': {
    title: 'Getting Started with Leonardo AI — Beginner Tutorial',
    desc: 'Learn Leonardo AI from scratch. Models, canvas editor, upscaling, and production workflows.',
    date: 'May 2026',
    content: [
      { type:'p', text:'Leonardo AI is the most beginner-friendly AI image generator with the best free tier. Here is how to start creating.' },
      { type:'h2', text:'Choose Your Model' },
      { type:'p', text:'Leonardo offers fine-tuned models: Leonardo Diffusion (general), DreamShaper (artistic), RPG (game assets), and Anime. Pick the model that matches what you are creating.' },
      { type:'h2', text:'Use the Canvas Editor' },
      { type:'p', text:'The canvas editor lets you inpaint (edit specific areas), outpaint (extend images), and combine elements. Select an area and describe what to add — the AI fills it naturally.' },
      { type:'h2', text:'Alchemy Upscaling' },
      { type:'p', text:'Toggle Alchemy before generating for higher detail. It adds realistic textures, better lighting, and sharper edges. Uses more credits but worth it for final outputs.' },
    ],
  },
  'surfer-seo-tutorial': {
    title: 'Surfer SEO Tutorial: How to Optimize Content for Rankings',
    desc: 'Complete Surfer SEO guide. Content editor, keyword research, and SERP analysis.',
    date: 'May 2026',
    content: [
      { type:'p', text:'Surfer SEO helps you write content that ranks. Here is how to use it effectively to outrank competitors.' },
      { type:'h2', text:'Step 1: Create a Content Editor' },
      { type:'p', text:'Enter your target keyword and Surfer analyzes the top 50 ranking pages. It gives you a content score, suggested word count, headings, keywords, and NLP entities to include.' },
      { type:'h2', text:'Step 2: Write to the Score' },
      { type:'p', text:'Write your content in the editor while watching the score update. Green means you are on track. Add suggested terms as you write — do not just stuff keywords, weave them naturally.' },
      { type:'h2', text:'Step 3: Analyze Competitors' },
      { type:'p', text:'The SERP Analyzer shows exactly what competitors are doing: their word count, backlinks, domain authority, and content structure. Use this to build something better.' },
    ],
  },
  'claude-tips-for-developers': {
    title: 'Claude AI Tips & Tricks for Developers (2026)',
    desc: 'Maximize Claude for coding, research, and problem-solving. Artifacts, projects, and context strategies.',
    date: 'May 2026',
    content: [
      { type:'p', text:'Claude is the best AI assistant for developers who need deep reasoning. Here is how to get the most out of it.' },
      { type:'h2', text:'Use the 200K Context Window' },
      { type:'p', text:'Upload entire codebases, documentation, or books. Claude can reason across all of it. Attach your package.json and tsconfig.json before asking coding questions for better answers.' },
      { type:'h2', text:'Artifacts for Interactive Output' },
      { type:'p', text:'When Claude generates code or documents, it creates an Artifact — a preview panel where you can see and interact with the result. Perfect for rapid prototyping.' },
      { type:'h2', text:'Projects for Organization' },
      { type:'p', text:'Create a Project for each codebase. Add custom instructions about your tech stack, coding style, and conventions. Claude remembers these across every conversation in that project.' },
    ],
  },
  'runway-tutorial-text-to-video': {
    title: 'Runway AI Tutorial: Create Videos from Text (2026)',
    desc: 'Learn Runway Gen-3 text-to-video. Motion tracking, green screen, and video editing with AI.',
    date: 'May 2026',
    content: [
      { type:'p', text:'Runway is the most complete AI video tool. Here is how to create professional videos without a camera or crew.' },
      { type:'h2', text:'Text to Video with Gen-3' },
      { type:'p', text:'Describe your scene and Runway generates a 4-16 second clip. Be specific about camera movement, lighting, and mood for the best results. "A drone shot flying over a mountain lake at sunrise, mist rising off the water."' },
      { type:'h2', text:'Motion Tracking' },
      { type:'p', text:'Select an object in your video and Runway tracks its movement. Add text or graphics that follow the object. Perfect for product demos and social media content.' },
      { type:'h2', text:'Green Screen Without a Green Screen' },
      { type:'p', text:'Runway can remove backgrounds from any video without a green screen. Select your subject and the AI separates it from the background. Replace with anything you want.' },
    ],
  },
  'synthesia-tutorial-ai-avatars': {
    title: 'Synthesia Tutorial: Create AI Avatar Videos Step by Step',
    desc: 'Make professional presenter videos with Synthesia. 140+ avatars, 120 languages, no filming needed.',
    date: 'May 2026',
    content: [
      { type:'p', text:'Synthesia lets you create professional presenter videos using AI avatars. No camera, no crew, no studio. Here is the complete workflow.' },
      { type:'h2', text:'Step 1: Choose Your Avatar' },
      { type:'p', text:'Pick from 140+ AI avatars or create a custom one. Avatars range from business casual to formal. Preview how each avatar delivers your script before finalizing.' },
      { type:'h2', text:'Step 2: Write Your Script' },
      { type:'p', text:'Type or paste your script. Synthesia supports 120+ languages with natural-sounding voices. Add pauses, emphasis, and pronunciation guides for professional delivery.' },
      { type:'h2', text:'Step 3: Add Visuals' },
      { type:'p', text:'Add slides, screen recordings, images, and text overlays. The avatar continues speaking while visuals change. Export in multiple formats for different platforms.' },
    ],
  },
};
